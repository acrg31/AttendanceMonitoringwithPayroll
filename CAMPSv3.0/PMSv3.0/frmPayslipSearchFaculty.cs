...
namespace PMSv3._0
{
    public partial class frmPayslipSearchFaculty : Form
    {
        ...
        public frmPayslipSearchFaculty()
        {
            InitializeComponent();
        ...
        public void loadbatch()
        {
            ...
            rpPayslip.LocalReport.ReportPath = @"Reports\PayslipFaculty.rdlc";
            rpPayslip.LocalReport.DataSources.Clear();
            da = new SqlDataAdapter();
            ds = new DataSet1();

            string sql = ("Select * from VtblPayslipFaculty WHERE EmployeeID like'"+txtSearch.Text+"'");
        ...
        private void frmPayslipSearch_Load(object sender, EventArgs e)
        {
